...
> Fix default homepage on newly created tabs (try catch)
> Fix fullscreen/download perms on newly created tabs
...
var browser = (function(configModule, tabsModule) {
  ...
  Browser.prototype.init = function() {
    ...
    (function(browser) {
      ...
      } catch(err) { console.log('error on fs perms (1st one)'); }
  ...
  Browser.prototype.doNewTab = function(e) {
    ...
    } catch(err) { console.log('error on fs perms (2nd one)'); }
